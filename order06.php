    ...
    <body>
     ...
     <div id="Navigation-bar">
      ...
      <div class="container">
             ...
             <h2 class="text-align" style="margin-bottom:-200px;" ><a href="order06.php">Confirm Your Order </a></h2>
      ...
      <div>
         <div class="recipe-image"></div>
          ...
          <img src= "foodrecipies/thai-curry-noodle-soup-109237-2.jpg" style="width:250px ;height:250px;border-radius:50px;margin-left:250px;margin-top:100px;" class="ResponsiveImage" > 
